...
let display_results = () => {
    ...
    //Get the results grade element
    let results_grade_el = document.querySelector('.results-grade');
    results_grade_el.innerHTML = (results_grade) ? "Congratulations You Passed!" : "Sorry, You Failed!";
    ...
    for(let index = 0; index < results_tracker.length; index++){
        ...
        ques_num_el.innerHTML = `${ques_num++}.`;
        ques_el.innerHTML     = results_tracker[index].data.ques;

        display_el.appendChild(ques_num_el);
        display_el.appendChild(ques_el);

        //Adding Styles to Ques Container
        display_el.classList.add("display-4");
        ques_num_el.classList.add("ques-number");
        ques_el.classList.add("ques");
        ques_container_el.classList.add("jumbotron", "ques-container", "results-ques-container");

        //Adding Ques Container
        ques_container_el.appendChild(display_el);
        ...
        let options_btn_container_el = document.createElement('div');
        ...
        options_btn_container_el.appendChild(btn_1);
        options_btn_container_el.appendChild(btn_2);
        options_btn_container_el.appendChild(btn_3);
        options_btn_container_el.appendChild(btn_4);

        btn_container_el.appendChild(options_btn_container_el);

        //Adding Styles to Button Container
        btn_container_el.classList.add("jumbotron", "btn-container");
        options_btn_container_el.classList.add("options-btn-container", "results-btn-container");
...
ipcRenderer.on('results_data:add', (e, results_data_grade, results_data_array, ques_data_array) => {

    console.log("RECEIVED RESULTS", results_data_grade, results_data_array, ques_data_array)
    ...
    results_grade = results_data_grade;
